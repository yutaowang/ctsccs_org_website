...
export type Family = { id: number; user_id: string; legacy_family_id?: number; email?: string; parent_first_name?: string; parent_last_name?: string; parent_chinese_name?: string; address?: string; city?: string; state?: string; zip?: string; phone?: string; wechat?: string; pfizer_employee?: boolean; waterford_resident?: boolean };
...
export type Course = { id: number; name?: string; short_name?: string; type?: string; donation?: number; classroom?: string; teacher_name?: string; teacher_short_name?: string; class_time_id?: number; display_time?: string; maximum?: number; is_open?: boolean; class_times?: { display_time?: string } | null };
