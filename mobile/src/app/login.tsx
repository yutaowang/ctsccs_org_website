...
export default function Login() {
  ...
  return <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : undefined} style={styles.page}>
    ...
    <View style={styles.brand}><Text style={styles.mark}>SCCS</Text><Text style={language === "zh" ? styles.chinese : styles.english}>{language === "zh" ? "东南康州中文学校" : "Southeastern Connecticut Chinese School"}</Text></View>
    <Card>
